...
function ProductPageContainer() {
    ...
    const description = product?.description || "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut commodi libero perspiciatis ratione reprehenderit assumenda itaque qui nam. Magni veniam minus voluptas deserunt laudantium, hic nesciunt et aspernatur consectetur debitis!"
        ...
        <div className="product-page w-[1200px] m-auto max-w-[100%]">
            {!product ? (
                <>
                    ...
                    <p className="text-2xl">The product your looking for does not exist. Check the URL and try again.</p>
                </>
            ):(
                <>
                    <div className="product mt-8 grid grid-cols-2 gap-8">
                        <div className="left">
                            <img className="w-full" src={product.image.filename} alt={product.title} />
                        </div>
                        <div className="right">
                            ...
                            {/*  */}
                            <button className="underline mb-4 text-xs">Size & Fit Guide</button>
                            {/*  */}
